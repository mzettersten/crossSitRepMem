/**
 * crossSitRep - learning
 * plugin for learning trials in cross-situational word learning study
* initial prompt
* based on:
...
jsPsych.plugins['learning-prompt'] = (function() {
  ...
  jsPsych.pluginAPI.registerPreload('learning-prompt', 'im1', 'image');
 jsPsych.pluginAPI.registerPreload('learning-prompt', 'im2', 'image');
  ...
  plugin.trial = function(display_element, trial) {
	  ...
	  trial.prompt = trial.prompt || "Learn the names for the two objects!";
	  ...
	  var topLeftCircle = paper.circle(225, 225, 110);
	  topLeftCircle.attr({
		  fill: "#ffffff",
		  stroke: "#000",
		  strokeWidth: 5
	  ...
	  var topRightCircle = paper.circle(575, 225, 110);
	  topRightCircle.attr({
		  fill: "#ffffff",
		  stroke: "#000",
		  strokeWidth: 5
